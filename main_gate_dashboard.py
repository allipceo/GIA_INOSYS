...
class MainGateDashboardCreator:
    def __init__(self):
        ...
        # MainGate 페이지 ID (URL에서 추출: MainGate-2579279b3d1e802598b7edc3bf8be5cc)
        self.main_gate_page_id = "2579279b3d1e802598b7edc3bf8be5cc"
    ...
    def create_main_gate_dashboard(self):
        ...
        try:
            ...
            print(f"📄 페이지 ID: {self.main_gate_page_id}")
